...
> [!TIP]
> To deploy this project using **GUI-based flow**, navigate to [console](https://console.stacktape.com/create-new-project/git-project-using-console?name=my-stacktape-app&repositoryType=public&repositoryUrl=https://github.com/stacktape/starter-event-driven-pipeline)

- Event-driven order processing pipeline using [SQS](https://docs.stacktape.com/resources/sqs-queues/),
  [EventBridge](https://docs.stacktape.com/resources/event-buses/), and
  [Step Functions](https://docs.stacktape.com/resources/state-machines/).
- Demonstrates reliable message processing with FIFO ordering, dead-letter queues, event routing, and workflow
  orchestration.
- Runs serverlessly — pay only for events you process.
...
```bash
stacktape init --starterId event-driven-pipeline
```
...
[dev command](https://docs.stacktape.com/cli/commands/dev/). For example, to develop and debug lambda function `submitOrder`, you can use

```bash
stacktape dev --region <<your-region>> --stage <<stage>> --resourceName submitOrder
```
